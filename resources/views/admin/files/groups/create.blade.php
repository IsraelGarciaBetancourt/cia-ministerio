...
<div class="max-w-3xl mx-auto px-4 py-8">
    <div class="mb-6">
        <a href="{{ route('files.groups.index') }}" class="text-sm text-blue-600 hover:underline">
            ← Volver a grupos
        </a>
    </div>

    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <h1 class="text-2xl font-bold text-gray-900 mb-4">Nuevo Grupo</h1>

        <form action="{{ route('files.groups.store') }}" method="POST" class="space-y-4">
            @csrf
